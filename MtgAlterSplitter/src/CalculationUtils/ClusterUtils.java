...
public class ClusterUtils {
	...
	public static void removeSpecs(BufferedImage image, int clusterSizeX, int clusterSizeY, int pixelOffsetX,
			int pixelOffsetY) {

		Cluster[][] clusterMatrix = createClusterMatrix(image, clusterSizeX, clusterSizeY, pixelOffsetX, pixelOffsetY);
		...
		for (int x = 0; x < clusterMatrix.length - 1; x++) {
			for (int y = 0; y < clusterMatrix[0].length - 1; y++) {
				...
				if ((middleMiddleCluster == null) || (upperLeftCluster == null) || (upperMiddleCluster == null)
						|| (upperRightCluster == null) || (middleLeftCluster == null) || (middleMiddleCluster == null)
						|| (middleRightCluster == null) || (lowerLeftCluster == null) || (lowerMiddleCluster == null)
						|| (lowerRighCluster == null)) {
					continue;
				}
				...
				if ((((upperLeftCluster.getValue() == 0) ? 1 : 0) + ((upperMiddleCluster.getValue() == 0) ? 1 : 0)
						+ ((upperRightCluster.getValue() == 0) ? 1 : 0) + ((middleLeftCluster.getValue() == 0) ? 1 : 0)
						+ ((middleRightCluster.getValue() == 0) ? 1 : 0) + ((lowerLeftCluster.getValue() == 0) ? 1 : 0)
	...
	public static void fillGaps(BufferedImage oldImage, BufferedImage newImage) {
		...
		for (int x = 0; x < newImage.getWidth() - 1; x++) {
			for (int y = 0; y < newImage.getHeight() - 1; y++) {
				...
				if ((((upperLeftPixel != -16777216) ? 1 : 0) + ((upperMiddlePixel != -16777216) ? 1 : 0)
						...
						+ ((lowerMiddlePixel != -16777216) ? 1 : 0) + ((lowerRighPixel != -16777216) ? 1 : 0)) > 4) {
